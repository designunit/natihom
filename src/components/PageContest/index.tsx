    ...
    const roadmapData = [
        ...
        },
        {
            ...
            text: (
                <>
                    <span>
                        Заявки принимаются (в соответствии с составом, указанным в п.3 Положений о Конкурсе и Техническим заданием) на электронную почту <a href='mailto:natihom@unit4.io'>natihom@unit4.io</a>
                    </span>
                    <span>
                        12 июля 2023 года
                    </span>
