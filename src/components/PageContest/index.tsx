    ...
    const roadmapData = [
        ...
        },
        {
            ...
            text: (
                <>
                    <span>
                        не позднее не позднее 3 августа 2023, 23:59 utc+3  участники, попавшие в шорт-лист, становятся резидентами “unit на тихом”
                    </span>
                </>
            ),
        },
        {
            ...
            text: (
                <>
                    <span>
                        Проведения резиденции и старт стройки
                    </span>
                    <span>
                        8 августа 2023
                    </span>
