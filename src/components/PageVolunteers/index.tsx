...
const data = [
    {
        ...
        text: (
            ...
            >
                <p>
                    Вы первый, к кому приходят гости резиденции со всеми вопросами и переживаниями. Мы заранее собираем всю нужную информацию, за пару дней до начала резиденции оформляем стенды. На самой резиденции — посменно дежурим и общаемся с участниками. А ещё ставим телефоны на зарядку и продаём красивые футболки.
                </p>
                <p>
    ...
    },
    {
        ...
        text: (
            ...
            >
                ...
                <p>
                    Мы будем рады если: ты быстро учишься, в состоянии забить гвоздь, тебе можно доверить шуруповёрт, и ты очень хочешь строить. Мы очень приветствуем исполнительность, дисциплинированность, физическую выносливость и бережное отношение к инструменту.
                </p>
